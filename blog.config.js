...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Easontian', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '鹅厂产品经理', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.easontian.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Eason, Blog', // 网站关键词 英文逗号隔开
  ...
  DESCRIPTION:'Welcome to Eason's blog!'// 站点描述，被notion中的页面描述覆盖
